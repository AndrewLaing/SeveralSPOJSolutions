...
Soon, the teacher realized that he has to step in: 
...
For each of the test cases output a single line with a single word "YES" if the candies 
can be distributed equally, or "NO" otherwise.
